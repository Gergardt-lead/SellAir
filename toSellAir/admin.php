...
<html>
	...
	<body>
				...
				<div class="navbar-header">
					...
					<div class="navbar-collapse collapse" id="navbar-main">
					  <ul class="nav navbar-nav">
						  ...
						  <li>
						 	 <a href="http://tosellair/admin.php?action=additem">Добавить товар</a>
						  </li>
						 <li>
						   <a href="http://tosellair/admin.php?action=allitems">Все товары</a>
						 </li>

						  <li>
						 	  <a href="http://tosellair/admin.php?action=allorders">Список заказов</a>
						  </li>
						  <li>
						    <a href="http://tosellair/admin.php?action=allnews">Новости сайта</a>
						  </li>
					  </ul>

					  <ul class="nav navbar-nav navbar-right">
						<li><a href="http://tosellair/" target="_blank">На сайт</a></li>
					  </ul>
		...
		<div id="wrapper" style="margin-top:25px;">
			<div class="content">
				<div class="conthead"><h1><?=$act_title?></h1></div>
				<div class="admnin-content">
					<?=$content?>
				</div>
			</div>
		</div>
